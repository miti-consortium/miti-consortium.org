...
A detailed specification of the standard is encoded in YAML files, available at https://github.com/miti-consortium/MITI and described in **[LINK TO PAPER]**. Individual files capture attributes, their description and significance, but also additional information that is essential for validating specific files; this includes ensuring that data in each field has the correct data type and that it meets constraints on valid values. Each attribute is associated with one of the following data types:
